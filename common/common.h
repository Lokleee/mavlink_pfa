...
#define MAVLINK_COMMON_XML_HASH 2564647067697873400
...
#ifndef HAVE_ENUM_OMNI_ATTITUDE_TARGET_TYPEMASK
#define HAVE_ENUM_OMNI_ATTITUDE_TARGET_TYPEMASK
typedef enum OMNI_ATTITUDE_TARGET_TYPEMASK
{
   OMNI_ATTITUDE_TARGET_TYPEMASK_BODY_ROLL_RATE_IGNORE=1, /* Ignore body roll rate | */
   OMNI_ATTITUDE_TARGET_TYPEMASK_BODY_PITCH_RATE_IGNORE=2, /* Ignore body pitch rate | */
   OMNI_ATTITUDE_TARGET_TYPEMASK_BODY_YAW_RATE_IGNORE=4, /* Ignore body yaw rate | */
   OMNI_ATTITUDE_TARGET_TYPEMASK_THRUST_BODY_SET=32, /* Use 3D body thrust setpoint instead of throttle | */
   OMNI_ATTITUDE_TARGET_TYPEMASK_THROTTLE_IGNORE=64, /* Ignore throttle | */
   OMNI_ATTITUDE_TARGET_TYPEMASK_ATTITUDE_IGNORE=128, /* Ignore attitude | */
   OMNI_ATTITUDE_TARGET_TYPEMASK_ENUM_END=129, /*  | */
} OMNI_ATTITUDE_TARGET_TYPEMASK;
#endif
...
#include "./mavlink_msg_set_omni_attitude_target.h"
#include "./mavlink_msg_omni_attitude_target.h"
#include "./mavlink_msg_hover_thrust_estimate.h"
