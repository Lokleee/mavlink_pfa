...
#define MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_LEN 55
#define MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_MIN_LEN 55
#define MAVLINK_MSG_ID_139_LEN 55
#define MAVLINK_MSG_ID_139_MIN_LEN 55

#define MAVLINK_MSG_ID_SET_ACTUATOR_CONTROL_TARGET_CRC 181
#define MAVLINK_MSG_ID_139_CRC 181

#define MAVLINK_MSG_SET_ACTUATOR_CONTROL_TARGET_FIELD_CONTROLS_LEN 11
...
#define MAVLINK_MESSAGE_INFO_SET_ACTUATOR_CONTROL_TARGET { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_set_actuator_control_target_t, time_usec) }, \
         { "group_mlx", NULL, MAVLINK_TYPE_UINT8_T, 0, 52, offsetof(mavlink_set_actuator_control_target_t, group_mlx) }, \
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 53, offsetof(mavlink_set_actuator_control_target_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 54, offsetof(mavlink_set_actuator_control_target_t, target_component) }, \
         { "controls", NULL, MAVLINK_TYPE_FLOAT, 11, 8, offsetof(mavlink_set_actuator_control_target_t, controls) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SET_ACTUATOR_CONTROL_TARGET { \
                               ...
                               uint64_t time_usec, uint8_t group_mlx, uint8_t target_system, uint8_t target_component, const float *controls)
{
    ...
    _mav_put_uint8_t(buf, 52, group_mlx);
    _mav_put_uint8_t(buf, 53, target_system);
    _mav_put_uint8_t(buf, 54, target_component);
    _mav_put_float_array(buf, 8, controls, 11);
    ...
    mav_array_memcpy(packet.controls, controls, sizeof(float)*11);
...
{
    return _MAV_RETURN_float_array(msg, controls, 11,  8);
}
